...
public:
	...
	bool LoadBmpFilealpha( const char *filename );		// Loads the bitmap from the specified file en maak een alpha kanaal bij
	...
	long GetNumBytesPerRowalpha() const { return ((4*NumCols+3)>>2)<<2; }	
